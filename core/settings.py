...
CACHES: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "PASSWORD": os.getenv(
                "REDIS_PASSWORD", None
            ),  # Set if password is configured
            "SOCKET_CONNECT_TIMEOUT": 5,  # Connection timeout
            "SOCKET_TIMEOUT": 5,  # Read/write timeout
            "RETRY_ON_TIMEOUT": True,  # Retry on timeout
            "MAX_CONNECTIONS": 1000,  # Maximum connections
            "CONNECTION_POOL_CLASS": "redis.connection.BlockingConnectionPool",  # Use blocking connection pool
...
CACHE_TTL: int = 60 * 15  # 15 minutes
CACHE_LONG_TTL: int = 60 * 60 * 24  # 24 hours

# Redis lock timeout settings
REDIS_LOCK_TIMEOUT: int = 60  # 60 seconds
